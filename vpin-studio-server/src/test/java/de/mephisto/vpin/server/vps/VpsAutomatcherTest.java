...
public class VpsAutomatcherTest {
  ...
  public void testMatch() {
    ...
    doMatch(matcher, vpsDatabase, "2001", "", null, "Wrd1972, Loserman76", "sMBqx5fp", "hOl7UpABdl", "");

    doMatch(matcher, vpsDatabase, "Cactus Canyon (Bally 1998)", "cc_13", null, null, "vZDUDUii", null, "");
    doMatch(matcher, vpsDatabase, "Cactus Canyon (Bally 1998)", "", null, null, "vZDUDUii", null, "");
    doMatch(matcher, vpsDatabase, "Cactus Canyon (1998 Bally)", "cc_13", null, null, "vZDUDUii", null, "");
    ...
    doMatch(matcher, vpsDatabase, "Cactus Canyon Continued", "", null, "VPW Team", "gBpX0hxi", "ZgnyWyHG", "");
    ...
    doMatch(matcher, vpsDatabase, "Dr Dude (Bally 1990)2.2", "", null, "Arconovum", "klXtdvkv", "Gu0H6FKV", "2.2");
    doMatch(matcher, vpsDatabase, "Dr Dude (1990)(Bally)_2.1b", "", null, "Arconovum", "klXtdvkv", "Gu0H6FKV", "2.1b");
    ...
    doMatch(matcher, vpsDatabase, "Guns n' Roses (DataEast1994) desktop version", "", null, "Versins77, Bigus1, TeamPP", "M7FYR1GJ", "SV-Ul3CNuE", "");
    ...
    doMatch(matcher, vpsDatabase, "Haunted House (Gottlieb 1982) 1.0", "", "Full Single Screen", null, "q0RmE-GZ", "KvxmJruh", "1.0");
    ...
    doMatch(matcher, vpsDatabase, "James Bond 007 (1980)", "", null, "Teisen, 23assassin", "628qJGb1", "Z5yroNaS20", "");
    ...
    doMatch(matcher, vpsDatabase, "Getaway, The - High Speed II v1.03", null, null, "", "cCV4A6uc", "YoXfmzDV", "1.03");
    doMatch(matcher, vpsDatabase, "Getaway 1.0 - melon - VP9.2 FS", "", null, null, "cCV4A6uc", "g0QpG_nVzj", "1.0");
    ...
    doMatch(matcher, vpsDatabase, "v.1 (IDSA 1986)", "", null, null, "32OBVwzC", "s8NeWzRw", "");  
