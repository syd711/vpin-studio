...
public class TableDataUtil {
  ...
  public static String getMappedValue(TableDetails tableDetails, String key) {
      return switch (key) {
          case "WEBGameID" -> tableDetails.getWebGameId();
          case "CUSTOM2" -> tableDetails.getCustom2();
          case "CUSTOM3" -> tableDetails.getCustom3();
          case "CUSTOM4" -> tableDetails.getCustom4();
          case "CUSTOM5" -> tableDetails.getCustom5();
          case "Special" -> tableDetails.getSpecial();
          case "MediaSearch" -> tableDetails.getMediaSearch();
          default -> throw new UnsupportedOperationException("Invalid popper mapping field " + key);
      };
  }
