...
public class VpaDownloadToRepositoryJob implements Job {
  ...
  public VpaDownloadToRepositoryJob(@NonNull VpaService vpaService,
                                    @NonNull SystemService systemService,
                                    @NonNull VpaDescriptor vpaDescriptor) {
  ...
  public boolean execute() {
    try {
      ...
      VpaSourceAdapterHttpServer source = (VpaSourceAdapterHttpServer) vpaService.getVpaSourceAdapter(vpaDescriptor.getSource().getId());
