...
import static de.mephisto.vpin.server.highscores.parser.HighscoreParser.toNumericScore;

public class DotColonHighscoreParser implements HighscoreAdapter {
