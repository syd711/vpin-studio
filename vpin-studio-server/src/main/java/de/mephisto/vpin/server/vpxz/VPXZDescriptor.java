...
public class VPXZDescriptor {
  ...
  public VPXZDescriptor(VPXZSource source, TableDetails tableDetails, VPXZPackageInfo packageInfo, OffsetDateTime createdAt, String filename, String absoluteFileName, long size) {
    this.source = source;
