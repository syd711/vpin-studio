...
public class Search {
  ...
  private List<String> expands = Arrays.asList("challenge.scoreboard", "challenge.scoreboard.participantProfilePicture", "challenge.pinballTableVersion.minimum", "challenge.pinballTable.minimum");
