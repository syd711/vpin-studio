...
public class BackupsSidebarController implements Initializable, StudioFXController {
  private final static Logger LOG = LoggerFactory.getLogger(BackupsSidebarController.class);
  ...
  public void setArchiveDescriptor(Optional<BackupDescriptorRepresentation> selection) {
    ...
    if (selection.isPresent()) {
      BackupDescriptorRepresentation descriptorRepresentation = selection.get();
      ...
      BackupPackageInfo packageInfo = descriptorRepresentation.getPackageInfo();
  ...
  private String applyValue(Label label, BackupFileInfo value) {
    if (value != null) {
