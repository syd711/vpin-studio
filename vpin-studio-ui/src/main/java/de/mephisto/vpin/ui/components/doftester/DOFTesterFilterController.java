...
import de.mephisto.vpin.ui.cards.HighscoreCardsPredicateFactory;
...
public class DOFTesterFilterController extends BaseFilterController<GameRepresentation, GameRepresentationModel> implements Initializable {
  ...
  private DOFTesterPredicateFactory predicateFactory;
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    predicateFactory = new DOFTesterPredicateFactory();
