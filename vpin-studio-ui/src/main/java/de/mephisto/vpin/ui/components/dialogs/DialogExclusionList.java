...
import de.mephisto.vpin.ui.tables.dialogs.AltColorUploadProgressModel;
...
public class DialogExclusionList implements Initializable, DialogController {
  ...
  private void onFileSelect(ActionEvent event) {
    ...
    if (DialogExclusionList.lastFolderSelection != null) {
      fileChooser.setInitialDirectory(DialogExclusionList.lastFolderSelection);
    }
  ...
  private void refreshSelection() {
    ...
    if(selection.getName().toLowerCase().endsWith(".zip")) {
      DialogExclusionList.lastFolderSelection = this.selection.getParentFile();
