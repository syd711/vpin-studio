...
public class AltSoundFileDropEventHandler implements EventHandler<DragEvent> {

  private final List<String> suffixes;
  private final TablesSidebarController tablesSidebarController;

  public AltSoundFileDropEventHandler(TablesSidebarController tablesSidebarController) {
  ...
  public void handle(DragEvent event) {
    ...
    Platform.runLater(() -> {
      ...
      if (filtered.isEmpty()) {
        ...
        TableDialogs.openAltSoundUploadDialog(tablesSidebarController, game, filtered.get(0));
      }
    });
  }
}
