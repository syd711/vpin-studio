  ...
  public static LocalizedValidation getValidationResult(@NonNull CompetitionRepresentation competition) {
    ...
    switch (code) {
      case DISCORD_SERVER_NOT_FOUND: {
        ...
        text = "The Discord server configured for this competition was not found.";
        break;
      }
      case DISCORD_CHANNEL_NOT_FOUND: {
        label = "Invalid Discord channel.";
        text = "The Discord channel configured for this competition was not found.";
        break;
      }
      case GAME_NOT_FOUND: {
        label = "No matching table found.";
        text = "The configured table for this competition does not exist anymore.";
        break;
      }
      default: {
