...
public class GenerateAllBackgroundsProgressModel extends ProgressModel<GameRepresentation> {
  private final static Logger LOG = LoggerFactory.getLogger(GenerateAllBackgroundsProgressModel.class);
  private List<GameRepresentation> games;

  private final Iterator<GameRepresentation> gameIterator;

  public GenerateAllBackgroundsProgressModel(List<GameRepresentation> games) {
    super("Re-generating All Default Backgrounds");
    this.games = games;
