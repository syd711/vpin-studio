...
public class VPXZSourceFolderDialogController implements Initializable, DialogController {
  private final static Logger LOG = LoggerFactory.getLogger(VPXZSourceFolderDialogController.class);
  ...
  private void onSaveClick(ActionEvent e) {
    this.source.setType(VPXZSourceType.Folder.name());
