...
public class ArchiveRestoreDialogController implements Initializable, DialogController {
  private final static Logger LOG = LoggerFactory.getLogger(ArchiveRestoreDialogController.class);
