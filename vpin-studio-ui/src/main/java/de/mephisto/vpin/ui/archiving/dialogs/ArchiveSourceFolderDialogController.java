...
public class ArchiveSourceFolderDialogController implements Initializable, DialogController {
  private final static Logger LOG = LoggerFactory.getLogger(ArchiveSourceFolderDialogController.class);
  ...
  private void onFileSelect() {
    ...
    if (ArchiveSourceFolderDialogController.lastFolderSelection != null) {
      chooser.setInitialDirectory(ArchiveSourceFolderDialogController.lastFolderSelection);
    }
    ...
    if (targetFolder != null) {
      ...
      ArchiveSourceFolderDialogController.lastFolderSelection = targetFolder;
