...
public class AltColorFileDropEventHandler implements EventHandler<DragEvent> {

  private final List<String> suffixes;
  private final TablesSidebarController tablesSidebarController;

  public AltColorFileDropEventHandler(TablesSidebarController tablesSidebarController) {
    this.tablesSidebarController = tablesSidebarController;
    this.suffixes = Arrays.asList("zip", "pac", "vni", "pal", "cRZ");
  }
  ...
  public void handle(DragEvent event) {
    ...
    Platform.runLater(() -> {
      ...
      if (filtered.isEmpty()) {
        ...
        TableDialogs.openAltColorUploadDialog(tablesSidebarController, game, filtered.get(0));
      }
    });
  }
}
