...
- **Highscore Parsing**: Added test coverage for over 50 new text file based highscores (thanks to @gorgatron) and added the missing parsing support for some of them.
