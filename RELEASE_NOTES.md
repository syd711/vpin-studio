...
- **VPS Tables Mappings**: VPS tables without a link are valid now. These entries have been filtered before, but it makes sense to keep them for the auto-matching and showing them as installed versions.
