...
public interface Ffmpeg {
  ...
  String OPEN_GL_COMMAND = "ffmpeg.exe -y -init_hw_device d3d11va:[adapter_idx] -filter_complex \"ddagrab=output_idx=[output_idx]:framerate=30:video_size=[width]x[height]:offset_x=[x]:offset_y=[y]:draw_mouse=0,hwdownload,format=bgra\" " +
