...
public class WidgetFactory {
  ...
  private static final List<KeywordRule> keywordRules = List.of(
      ...
      new KeywordRule("twenties", "customicon-twenties_icon", MatchType.PREFIX),
      new KeywordRule("20", "customicon-twenties_icon", MatchType.ANYWHERE),
      new KeywordRule("now", "customicon-now_icon", MatchType.ANYWHERE),
